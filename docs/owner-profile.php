...
<head>
  ...
  <style>
    ...
    .avatar {
      ...
      border: 4px solid rgba(82,183,136,.18);
    }
  ...
  <header class="gr-header">
    <nav class="gr-nav">
      ...
      <ul class="gr-navlinks">
        ...
        <li><a href="add-edit-equipment.html">Manage Equipment</a></li>
  ...
  <main class="profile-page">
    <section class="profile-hero">
      <div class="hero-content">
        ...
        <h1>Manage your account and equipment activity</h1>
        <p>
          View your owner information, check your equipment summary,
          and manage your activity across listings and reservations from one place.
        </p>
      </div>

      <div class="hero-actions">
        <a href="owner-dashboard.php" class="btn btn-soft">Back to Dashboard</a>
        <a href="#" class="btn btn-solid">Edit Profile</a>
      </div>
    </section>
    ...
    <section class="profile-layout">
      <div class="profile-card">
        <div class="profile-main">
          ...
          <h2><?= e($fullName) ?></h2>
          <div class="role-badge">Equipment Owner</div>
          <p>
            Equipment owner offering reliable agricultural machinery for rent through GreenRent.
          </p>
          ...
          <div class="contact-list">
            ...
            <div class="contact-item">
              ...
              <div class="contact-text">
                ...
                <span><?= e($owner['phone_number']) ?></span>
              </div>
            </div>
            ...
            <div class="contact-item">
              ...
              <div class="contact-text">
                ...
                <span><?= e(ucfirst($owner['status'])) ?></span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div>
        <section class="details-card" style="margin-bottom:24px;">
          <div class="card-head">
            <h3>Profile Details</h3>
            <span>Basic owner account information</span>
          </div>
          ...
          <div class="details-body">
            <div class="details-grid">
              ...
              <div class="detail-box">
                ...
                <div class="detail-value">Equipment Owner</div>
              </div>

              <div class="detail-box">
                <div class="detail-label">Email</div>
                <div class="detail-value"><?= e($owner['email']) ?></div>
              </div>

              <div class="detail-box">
                <div class="detail-label">Phone</div>
                <div class="detail-value"><?= e($owner['phone_number']) ?></div>
              </div>

              <div class="detail-box about-box">
                <div class="detail-label">About</div>
                <div class="detail-value">
                  This account can list equipment, view related reservations, and manage owner profile information.
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="activity-card">
          <div class="card-head">
            <h3>Owner Activity Overview</h3>
            <span>Listings and reservation summary</span>
          </div>
          ...
          <div class="activity-body">
            <div class="stats-grid">
              <div class="stat-card">
                ...
                <div class="stat-value"><?= e($stats['equipment_count']) ?></div>
                <div class="stat-label">Listed Equipment</div>
              </div>

              <div class="stat-card">
                <div class="stat-icon">📅</div>
                <div class="stat-value"><?= e($stats['reservation_count']) ?></div>
                <div class="stat-label">Reservations</div>
              </div>

              <div class="stat-card">
                <div class="stat-icon">⭐</div>
                <div class="stat-value"><?= e($stats['avg_rating']) ?></div>
                <div class="stat-label">Average Rating</div>
              </div>

              <div class="stat-card">
                <div class="stat-icon">✅</div>
                <div class="stat-value"><?= e($stats['confirmed_count']) ?></div>
                <div class="stat-label">Confirmed Bookings</div>
              </div>
            </div>

            <div class="recent-box">
              <h4>Recent Equipment Activity</h4>

              <div class="recent-list">
                <?php if ($recentEquipment->num_rows > 0): ?>
                  <?php while ($item = $recentEquipment->fetch_assoc()): ?>
                    <div class="recent-item">
                      <div>
                        <strong><?= e($item['equipment_name']) ?></strong>
                        <span><?= e($item['price_per_day']) ?> SAR / day</span>
                      </div>
                      <span class="status-badge status-<?= e($item['availability_status']) ?>">
