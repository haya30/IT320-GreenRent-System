  ...
  <main class="profile-page">
    <section class="profile-hero">
      <div class="hero-content">
        ...
        <h1>Manage your account and reservation activity</h1>
        <p>
          View your personal information, track your reservation summary,
          and keep your farmer profile updated in one organized place.
        </p>
      </div>

      <div class="hero-actions">
        <a href="my-reservations.php" class="btn btn-soft">My Reservations</a>
    ...
    <section class="profile-layout">
      <div class="profile-card">
        <div class="profile-main">
          ...
          <h2><?= e($fullName) ?></h2>
          <div class="role-badge">Farmer</div>
          <p>
            Farmer interested in renting reliable agricultural equipment for seasonal and daily farm operations.
          </p>
          ...
          <div class="contact-list">
            ...
            <div class="contact-item">
              ...
              <div class="contact-text">
                ...
                <span><?= e($farmer['phone_number']) ?></span>
              </div>
            </div>
            ...
            <div class="contact-item">
              ...
              <div class="contact-text">
                ...
                <span><?= e(ucfirst($farmer['status'])) ?></span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="details-body">
            <div class="details-grid">
              ...
              <div class="detail-box">
                ...
                <div class="detail-value">Farmer</div>
              </div>

              <div class="detail-box">
                <div class="detail-label">Email</div>
                <div class="detail-value"><?= e($farmer['email']) ?></div>
              </div>

              <div class="detail-box">
                <div class="detail-label">Phone</div>
                <div class="detail-value"><?= e($farmer['phone_number']) ?></div>
              </div>

              <div class="detail-box about-box">
                <div class="detail-label">About</div>
                <div class="detail-value">
                  This account can browse equipment, make reservations, view reservations, and submit reviews after completed bookings.
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="activity-body">
            <div class="stats-grid">
              <div class="stat-card">
                ...
                <div class="stat-value"><?= e($totalReservations) ?></div>
                <div class="stat-label">Total Reservations</div>
              </div>

              <div class="stat-card">
                <div class="stat-icon">✅</div>
                <div class="stat-value"><?= e($confirmedReservations) ?></div>
                <div class="stat-label">Confirmed</div>
              </div>

              <div class="stat-card">
                <div class="stat-icon">⭐</div>
                <div class="stat-value"><?= e($totalReviews) ?></div>
                ...
                <?php if ($recentReservations->num_rows > 0): ?>
                  <?php while($res = $recentReservations->fetch_assoc()): ?>
                    <div class="recent-item">
                      <div>
                        <strong><?= e($res['equipment_name']) ?></strong>
                        <span><?= e($res['start_date']) ?> — <?= e($res['end_date']) ?></span>
                      </div>
                      <span class="status-badge status-<?= e($res['reservation_status']) ?>">
                        <?= e(ucfirst($res['reservation_status'])) ?>
                      </span>
                    </div>
                  <?php endwhile; ?>
                <?php else: ?>
